...
const PRODUTOS_MOCK = [
  ...
  { id: 'p3', descricao: 'Extintor Novo Água 10L', valor: 150.00 },
  { id: 'p4', descricao: 'Manutenção Nível 2', valor: 45.00 },
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                ...
                >
                  ...
                  <Text className="text-[#cc0000] font-bold">R$ {item.valor.toFixed(2).replace('.', ',')}</Text>
                </TouchableOpacity>
              )}
            />
          </View>
